...
function Login({
  ...
  const submit = async () => {
    ...
    try {
      ...
      const { data: isAllowed } = await supabaseClient.rpc(accessRpc, { p_email: emailVal });
      if (!isAllowed) {
        setStage("error");
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "See how guests move through the space."), /*#__PURE__*/React.createElement("p", {
    className: "mt-4 text-[15px] leading-relaxed max-w-[44ch]",
    style: {
      color: "var(--rail-text)"
    }
  }, "Fossyl Glance turns virtual tour visits into signal. See which rooms and details hold attention, which properties pull traffic, and how engaged each visit really was."), /*#__PURE__*/React.createElement("dl", {
    className: "mt-8 grid grid-cols-3 gap-5 max-w-md"
  }, [["buildings", "Property analytics", "views, hotspots & KPIs"], ["ranking", "Top properties", "ranked by visits"], ["pulse", "Activity pulse", "visitor activity at a glance"]].map(([ic, t, s]) => /*#__PURE__*/React.createElement("div", {
    key: t,
    ...
    className: "mt-2 text-sm font-bold text-ink whitespace-nowrap"
  ...
  }, stage === "error" ? err : "Only enrolled users can sign in.")), /*#__PURE__*/React.createElement("button", {
    onClick: submit,
